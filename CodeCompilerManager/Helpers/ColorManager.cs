...
namespace CodeCompilerServiceManager.Helpers
{
    ...
    {
        public static Color PrimaryColor { get; set; } = ((int)Primary.Indigo500).ToColor();//ColorTranslator.FromHtml("#388E3C");
        public static Color PrimaryColorAccent { get; set; } = ((int)Primary.Indigo700).ToColor(); //ColorTranslator.FromHtml("#47894B");
        public static Color SecondaryColor { get; set; } = ((int)Primary.Pink200).ToColor(); //ColorTranslator.FromHtml("#FF8A80");
        public static Color SecondaryColorAccent { get; set; } = ((int)Primary.Pink500).ToColor();//ColorTranslator.FromHtml("#FFB4AD");
        public static Color BackColorSidePanel { get; set; } = ColorTranslator.FromHtml("#33334C");
